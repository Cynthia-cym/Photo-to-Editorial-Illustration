...
> Install the `photo-abstraction` skill from `https://github.com/Cynthia-cym/Photo-to-Editorial-Illustration/tree/main/photo-abstraction`.
...
Attach exactly one photograph and ask Codex to transform it with the `photo-abstraction` Skill. The workflow accepts JPG/JPEG, PNG, static WebP, MPO, and HEIC/HEIF source images. It performs one image-transformation generation and then assembles the final layout deterministically.
...
- the `photo-abstraction` Skill instructions;
...
The Skill code and documentation are licensed under the MIT License. The bundled Noto Sans font remains licensed under the SIL Open Font License 1.1 in `photo-abstraction/assets/fonts/OFL.txt`.
